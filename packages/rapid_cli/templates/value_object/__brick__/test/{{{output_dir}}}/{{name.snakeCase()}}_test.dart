...
import 'package:{{project_name}}_domain{{#has_subdomain_name}}_{{subdomain_name}}{{/has_subdomain_name}}{{^output_dir_is_cwd}}/{{{output_dir}}}{{/output_dir_is_cwd}}/{{name.snakeCase()}}.dart';
