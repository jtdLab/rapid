...
void main() {
  ...
  group('ProjectNoneLoggerDevelopment', () {
    ...
    late ProjectNoneLoggerDevelopment underTest;
    ...
    setUp(() {
      ...
      underTest = ProjectNoneLoggerDevelopment()
  ...
  group('ProjectNoneLoggerTest', () {
    late LogCommand logCommand;
    late ProjectNoneLoggerTest underTest;
    ...
    setUp(() {
      ...
      underTest = ProjectNoneLoggerTest()..logCommandOverrides = logCommand;
    });
  ...
  group('ProjectNoneLoggerProduction', () {
    late LogCommand logCommand;
    late ProjectNoneLoggerProduction underTest;
    ...
    setUp(() {
      ...
      underTest = ProjectNoneLoggerProduction()
        ..logCommandOverrides = logCommand;
    });
