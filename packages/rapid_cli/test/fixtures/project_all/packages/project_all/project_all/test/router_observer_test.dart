...
import 'package:project_all/router_observer.dart';
import 'package:project_all_logging/project_all_logging.dart';
import 'package:mocktail/mocktail.dart';

class _MockProjectAllLogger extends Mock implements ProjectAllLogger {}
...
void main() {
  group('ProjectAllRouterObserver', () {
    late ProjectAllLogger logger;
    late ProjectAllRouterObserver underTest;

    setUp(() {
      logger = _MockProjectAllLogger();
      when(() => logger.debug(any())).thenReturn(null);
      underTest = ProjectAllRouterObserver(logger);
    });
