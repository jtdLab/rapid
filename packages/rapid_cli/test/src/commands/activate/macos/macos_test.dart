  ...
  group('activate macos', () {
    ...
    test('completes successfully with correct output', () async {
      ...
      verify(() => appPackagePubspec.setDependency('${projectName}_macos_app'))
          .called(1);
      verify(() => mainFileDev.addSetupForPlatform(Platform.macos)).called(1);
      verify(() => mainFileTest.addSetupForPlatform(Platform.macos)).called(1);
      verify(() => mainFileProd.addSetupForPlatform(Platform.macos)).called(1);
