...
void main() {
  group('ProjectMacosApp', () {
    ...
    ProjectMacosApp projectMacosApp() => ProjectMacosApp(
    ...
    testWidgets('renders MacosApp with correct properties', (tester) async {
      // Act
    ...
    testWidgets(
        'renders MacosApp with correct properties when home is not null and brightness is light',
        (tester) async {
      // Arrange
    ...
    testWidgets(
        'renders MacosApp with correct properties when home is not null and brightness is dark',
        (tester) async {
      // Arrange
      locale = const Locale('en');
