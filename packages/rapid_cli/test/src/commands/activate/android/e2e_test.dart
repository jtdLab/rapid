    ...
    () {
      ...
      test(
        ...
        () async {
          ...
          final activateAndroidResult = await commandRunner.run(
            ['activate', 'android'],
          );
          expect(activateAndroidResult, equals(ExitCode.success.code));
          ...
          final integrationTestResult = await Process.run(
            'flutter',
            ['test', 'integration_test/development_test.dart', '-d', 'android'],
