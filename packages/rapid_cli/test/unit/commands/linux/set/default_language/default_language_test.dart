...
const expectedUsage = [
  'Set the default language of the Linux part of an existing Rapid project.\n'
      '\n'
      'Usage: rapid linux set default_language <language>\n'
...
void main() {
  group('linux set default_language', () {
    ...
    late LinuxSetDefaultLanguageCommand command;
    ...
    setUp(() {
      ...
      command = LinuxSetDefaultLanguageCommand(
        logger: logger,
        project: project,
    ...
    test('default_lang is a valid alias', () {
      // Arrange
      command = LinuxSetDefaultLanguageCommand(project: project);
    ...
    test(
      ...
      withRunner((commandRunner, logger, printLogs) async {
        ...
        final result = await commandRunner.run(
          ['linux', 'set', 'default_language', '--help'],
        );
    ...
    test(
      ...
      withRunnerOnProject(
        ...
        // Act
        final result =
            await commandRunner.run(['linux', 'set', 'default_language']);
    ...
    test(
      ...
      withRunnerOnProject(
        ...
        final result = await commandRunner
            .run(['linux', 'set', 'default_language', 'de', 'fr']);
    ...
    test(
      ...
      withRunnerOnProject(
        ...
        // Act
        final result = await commandRunner
            .run(['linux', 'set', 'default_language', language]);
    ...
    test('completes successfully with correct output', () async {
      ...
      verify(
        () => logger.success(
          'Set $language as the default language of the Linux part of your project.',
        ),
      ).called(1);
      verify(() => logger.info('')).called(1);
