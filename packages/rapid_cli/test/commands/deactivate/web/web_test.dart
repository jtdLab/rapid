...
void main() {
  group('web', () {
    ...
    setUp(() {
      ...
      when(() => injectionFile.getPackagesByPlatform(Platform.web))
      ...
      when(() => project.platformDir(Platform.web)).thenReturn(platformDir);
    ...
    test('completes successfully with correct output', () async {
      ...
      verify(() => injectionFile.getPackagesByPlatform(Platform.web)).called(1);
    ...
    test('completes with correct output when web is not activated', () async {
      // Arrange
