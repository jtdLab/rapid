import 'package:test_app_logging/src/logger.dart';
...
void main() {
  ...
  group('TestAppLoggerDevelopment', () {
    late LogCommand logCommand;
    late TestAppLoggerDevelopment underTest;
    ...
    setUp(() {
      ...
      underTest = TestAppLoggerDevelopment()..logCommandOverrides = logCommand;
    });
  ...
  group('TestAppLoggerTest', () {
    late LogCommand logCommand;
    late TestAppLoggerTest underTest;
    ...
    setUp(() {
      ...
      underTest = TestAppLoggerTest()..logCommandOverrides = logCommand;
    });
  ...
  group('TestAppLoggerProduction', () {
    late LogCommand logCommand;
    late TestAppLoggerProduction underTest;
    ...
    setUp(() {
      ...
      underTest = TestAppLoggerProduction()..logCommandOverrides = logCommand;
    });
