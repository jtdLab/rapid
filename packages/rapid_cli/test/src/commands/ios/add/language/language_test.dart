...
const expectedUsage = [
  'Adds a language to the iOS part of an existing Rapid project.\n'
      '\n'
...
void main() {
 ...
 This command should be run from the root of your Rapid project.''')).called(1);
    ...
    test('exits with 78 when no iOS features exist', () async {
      ...
      // Assert
      verify(() => logger.err('No iOS features found!\n'
    ...
    test(
      ...
      // Assert
      verify(() => logger.err('The iOS part of your project is corrupted.\n'
