...
void main() {
  ...
  group('ProjectMacosLoggerDevelopment', () {
    ...
    late ProjectMacosLoggerDevelopment underTest;
    ...
    setUp(() {
      ...
      underTest = ProjectMacosLoggerDevelopment()
  ...
  group('ProjectMacosLoggerTest', () {
    late LogCommand logCommand;
    late ProjectMacosLoggerTest underTest;
    ...
    setUp(() {
      ...
      underTest = ProjectMacosLoggerTest()..logCommandOverrides = logCommand;
    });
  ...
  group('ProjectMacosLoggerProduction', () {
    late LogCommand logCommand;
    late ProjectMacosLoggerProduction underTest;
    ...
    setUp(() {
      ...
      underTest = ProjectMacosLoggerProduction()
        ..logCommandOverrides = logCommand;
    });
