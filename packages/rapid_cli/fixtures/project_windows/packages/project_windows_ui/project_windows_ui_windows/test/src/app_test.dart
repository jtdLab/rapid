...
void main() {
  group('ProjectWindowsApp', () {
    ...
    ProjectWindowsApp getApp() => ProjectWindowsApp(
    ...
    testWidgets('returns FluentApp with correct properties', (tester) async {
      // Act
    ...
    testWidgets(
        'returns FluentApp with correct properties when home is not null',
        (tester) async {
      // Arrange
