...
- `rapid domain <subdomain>`: Work with the subdomain <subdomain>.
  ...
  - `rapid domain <subdomain> add`: Remove a component from the subdomain <subdomain>.
    - `rapid domain <subdomain> add entity`: Remove a entity from the subdomain <subdomain>.
    - `rapid domain <subdomain> add service_interface`: Remove a service interface from the subdomain <subdomain>.
    - `rapid domain <subdomain> add value_object`: Remove a value object from the subdomain <subdomain>.
