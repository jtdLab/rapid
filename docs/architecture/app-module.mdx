...
<div>
  ...
  <Chip color="#FF66CC">get_it, injectable</Chip>
</div>
...
<div>
  ...
  <Chip color="#FF66CC">auto_route</Chip>
  <Chip color="#FF66CC">bloc, bloc_concurrency</Chip>
  <Chip color="#FF66CC">get_it, injectable</Chip>
</div>
...
<div>
  <Chip color="#CCCCCC">core</Chip>
  <Chip color="#FF66CC">flutter_localizations</Chip>
  <Chip color="#FF66CC">intl</Chip>
</div>
...
<div>
  ...
  <Chip color="#FF5252">application</Chip>
  <Chip color="#FF66CC">auto_route</Chip>
  <Chip color="#FF66CC">bloc, flutter_bloc</Chip>
  <Chip color="#FF66CC">freezed</Chip>
...
<div>
  ...
  <Chip color="#FF66CC">injectable</Chip>
  <Chip color="#FF66CC">freezed</Chip>
  <Chip color="#FF66CC">json_serializable</Chip>
</div>
