...
/// The log level of an [ProjectLinuxLogger].
enum Level {
  verbose(0),
  debug(500),
  info(800),
...
abstract class ProjectLinuxLogger {
  final Level level;

  @visibleForTesting
  LogCommand? logCommandOverrides;

  ProjectLinuxLogger(this.level);
...
@dev
@LazySingleton(as: ProjectLinuxLogger)
class ProjectLinuxLoggerDevelopment extends ProjectLinuxLogger {
  ProjectLinuxLoggerDevelopment() : super(Level.debug);
}
...
@test
@LazySingleton(as: ProjectLinuxLogger)
class ProjectLinuxLoggerTest extends ProjectLinuxLogger {
  ProjectLinuxLoggerTest() : super(Level.verbose);
}

/// In production mode we log nothing for security reasons.
@prod
@LazySingleton(as: ProjectLinuxLogger)
class ProjectLinuxLoggerProduction extends ProjectLinuxLogger {
  ProjectLinuxLoggerProduction() : super(Level.debug);
}
