...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    {{#mobile}}await _i17.{{project_name.pascalCase()}}MobileAppPackageModule().init(gh);{{/mobile}}
    {{#mobile}}await _i18.{{project_name.pascalCase()}}MobileHomePagePackageModule().init(gh);{{/mobile}}
    return this;
  }
}
