...
const expectedUsage = [
  'Set the default language of the Android part of an existing Rapid project.\n'
      '\n'
      'Usage: rapid android set default_language <language>\n'
...
void main() {
  group('android set default_language', () {
    ...
    late AndroidSetDefaultLanguageCommand command;
    ...
    setUp(() {
      ...
      command = AndroidSetDefaultLanguageCommand(
        logger: logger,
        project: project,
    ...
    test('default_lang is a valid alias', () {
      // Arrange
      command = AndroidSetDefaultLanguageCommand(project: project);
    ...
    test(
      ...
      withRunner((commandRunner, logger, printLogs) async {
        ...
        final result = await commandRunner.run(
          ['android', 'set', 'default_language', '--help'],
        );
        ...
        final resultAbbr = await commandRunner.run(
          ['android', 'set', 'default_language', '-h'],
        );
    ...
    test(
      ...
      withRunnerOnProject(
        ...
        // Act
        final result =
            await commandRunner.run(['android', 'set', 'default_language']);
    ...
    test(
      ...
      withRunnerOnProject(
        ...
        final result = await commandRunner
            .run(['android', 'set', 'default_language', 'de', 'fr']);
    ...
    test(
      ...
      withRunnerOnProject(
        ...
        // Act
        final result = await commandRunner
            .run(['android', 'set', 'default_language', language]);
    ...
    test('completes successfully with correct output', () async {
      ...
      verify(
        () => logger.success(
          'Set $language as the default language of the Android part of your project.',
        ),
      ).called(1);
      verify(() => logger.info('')).called(1);
