...
<div>
  ...
  <Chip color="#FF66CC">get_it</Chip>
  <Chip color="#FF66CC">injectable</Chip>
</div>

<div>
  <BoldText>🎯 Provide a dependency injection container.</BoldText>
  <BoldText>🎯 Provide platform annotations for dependency injection.</BoldText>
</div>
...
<BoldText>🎯 Provide a logger.</BoldText>
...
<BoldText>🎯 Provide entrypoints to run the application in different environments.</BoldText>

<BoldText>🎯 Setup Dependency Injection.</BoldText>

<BoldText>🎯 Setup Routing.</BoldText>

<BoldText>🎯 Provide a BlocObserver.</BoldText>

<BoldText>🎯 Provide a RouterObserver.</BoldText>

<BoldText>🎯 Integration Testing.</BoldText>
...
<BoldText>🎯 Provide interfaces to navigate between feature packages.</BoldText>
...
<BoldText>🎯 Provide translations for different languages.</BoldText>
...
<BoldText>🎯 Implement states and user interface of a feature.</BoldText>
...
<BoldText>🎯 Represent a domain using [Entities](/architecture/app-module#entity), [Service Interfaces](/architecture/app-module#service-interface) and [Value Objects](/architecture/app-module#value-object).</BoldText>
...
<BoldText>🎯 Implement its associated [Domain Package](/architecture/app-module#domain-package).</BoldText>
