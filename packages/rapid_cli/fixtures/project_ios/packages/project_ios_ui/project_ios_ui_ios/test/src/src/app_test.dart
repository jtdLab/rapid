...
void main() {
  group('ProjectIosApp', () {
    ...
    ProjectIosApp getApp() => ProjectIosApp(
    ...
    testWidgets('returns CupertinoApp with correct properties', (tester) async {
      // Act
    ...
    testWidgets(
        'returns CupertinoApp with correct properties when home is not null and brightness is light',
        (tester) async {
      // Arrange
    ...
    testWidgets(
        'returns MaterialApp with correct properties when home is not null and brightness is dark',
        (tester) async {
      // Arrange
      locale = const Locale('en');
