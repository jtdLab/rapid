...
const expectedUsage = [
  'Add a feature to the Android part of an existing Rapid project.\n'
      '\n'
...
void main() {
  group('android add feature', () {
    ...
    test('feat is a valid alias', () {
      // Arrange
      command = AndroidAddFeatureCommand(project: project);
    ...
    test('completes successfully with correct output', () async {
      ...
      verify(() => logger.success('Added Android feature $name.')).called(1);
      verify(() => logger.info('')).called(1);
