...
## Dependency Injection Package <Chip color="#CCCCCC">core</Chip>

<div>
  <Chip color="#A52A2A">get_it, injectable</Chip>
</div>
...
## Platform Root Package <div><Chip color="#CCCCCC">core</Chip><Chip color="#F9C909">presentation</Chip><Chip color="#FF5252">application</Chip></div>

<div>
  <Chip color="#A52A2A">auto_route</Chip>
  <Chip color="#A52A2A">bloc, bloc_concurrency</Chip>
  <Chip color="#A52A2A">get_it, injectable</Chip>
</div>
...
<div>
  <Chip color="#CCCCCC">core</Chip>
  <Chip color="#A52A2A">flutter_localizations</Chip>
  <Chip color="#A52A2A">intl</Chip>
</div>
...
<div>
  ...
  <Chip color="#A52A2A">auto_route</Chip>
  <Chip color="#A52A2A">bloc, flutter_bloc</Chip>
  <Chip color="#A52A2A">freezed</Chip>
  <Chip color="#A52A2A">injectable</Chip>
</div>
...
<div>
  ...
  <Chip color="#A52A2A">injectable</Chip>
  <Chip color="#A52A2A">freezed</Chip>
  <Chip color="#A52A2A">json_serializable</Chip>
</div>
