...
const expectedUsage = [
  'Set the default language of the Web part of an existing Rapid project.\n'
      '\n'
      'Usage: rapid web set default_language <language>\n'
...
void main() {
  group('web set default_language', () {
    ...
    late WebSetDefaultLanguageCommand command;
    ...
    setUp(() {
      ...
      command = WebSetDefaultLanguageCommand(
        logger: logger,
        project: project,
    ...
    test('default_lang is a valid alias', () {
      // Arrange
      command = WebSetDefaultLanguageCommand(project: project);
    ...
    test(
      ...
      withRunnerOnProject(
        ...
        // Act
        final result =
            await commandRunner.run(['web', 'set', 'default_language']);
    ...
    test(
      ...
      withRunnerOnProject(
        ...
        final result = await commandRunner
            .run(['web', 'set', 'default_language', 'de', 'fr']);
    ...
    test(
      ...
      withRunnerOnProject(
        ...
        // Act
        final result = await commandRunner
            .run(['web', 'set', 'default_language', language]);
    ...
    test('completes successfully with correct output', () async {
      ...
      verify(
        () => logger.success(
          'Set $language as the default language of the Web part of your project.',
        ),
      ).called(1);
      verify(() => logger.info('')).called(1);
