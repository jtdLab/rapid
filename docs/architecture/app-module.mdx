...
<BoldText>🎯 Provide a dependency injection container.</BoldText></br>

<BoldText>🎯 Provide platform annotations for dependency injection.</BoldText></br>
...
<BoldText>🎯 Provide a logger.</BoldText></br>
...
<BoldText>🎯 Provide entrypoints to run the application in different environments.</BoldText></br>

<BoldText>🎯 Setup Dependency Injection.</BoldText></br>

<BoldText>🎯 Setup Routing.</BoldText></br>

<BoldText>🎯 Provide a BlocObserver.</BoldText></br>

<BoldText>🎯 Provide a RouterObserver.</BoldText></br>

<BoldText>🎯 Integration Testing.</BoldText></br>
...
<BoldText>🎯 Provide interfaces to navigate between feature packages.</BoldText></br>
...
<BoldText>🎯 Provide translations for different languages.</BoldText></br>
...
<BoldText>🎯 Implement states and user interface of a feature.</BoldText></br>
...
<BoldText>🎯 Represent a domain using [Entities](/architecture/app-module#entity), [Service Interfaces](/architecture/app-module#service-interface) and [Value Objects](/architecture/app-module#value-object).</BoldText></br>
...
<BoldText>🎯 Implement its associated [Domain Package](/architecture/app-module#domain-package).</BoldText></br>
