...
ProjectWebApp _getProjectWebApp({
  Locale? locale,
...
ProjectWebApp _getProjectWebAppTest({
  Locale? locale,
  Iterable<LocalizationsDelegate<dynamic>>? localizationsDelegates,
  ThemeMode? themeMode,
  required Widget home,
}) {
  return ProjectWebApp.test(
    locale: locale,
    localizationsDelegates: localizationsDelegates,
    themeMode: themeMode,
    home: home,
...
void main() {
  group('ProjectWebApp', () {
    testWidgets('renders MaterialApp correctly', (tester) async {
      ...
      final projectWebApp = _getProjectWebApp(
        supportedLocales: supportedLocales,
        localizationsDelegates: localizationsDelegates,
        routerConfig: routerConfig,
      );
      ...
      // Act
      await tester.pumpWidget(projectWebApp);
  ...
  group('ProjectWebApp.test', () {
    testWidgets('renders MaterialApp correctly', (tester) async {
      // Arrange
      final localizationsDelegates = [FakeLocalizationsDelegate()];
      final home = Container();
      final projectWebApp = _getProjectWebAppTest(
