...
//@GeneratedMicroModule;{{project_name.pascalCase()}}Mobile{{name.pascalCase()}}PackageModule;package:{{project_name}}_mobile_{{name}}/src/injection.module.dart
// GENERATED CODE - DO NOT MODIFY BY HAND
// ignore_for_file: no_leading_underscores_for_library_prefixes
import 'dart:async' as _i2;
...
// ignore_for_file: unnecessary_lambdas
// ignore_for_file: lines_longer_than_80_chars
class {{project_name.pascalCase()}}Mobile{{name.pascalCase()}}PackageModule extends _i1.MicroPackageModule {
  // initializes the registration of main-scope dependencies inside of [GetIt]
  @override
  _i2.FutureOr<void> init(_i1.GetItHelper gh) {}
}
