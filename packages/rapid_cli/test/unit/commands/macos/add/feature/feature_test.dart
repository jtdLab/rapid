...
const expectedUsage = [
  'Add a feature to the macOS part of an existing Rapid project.\n'
      '\n'
...
void main() {
  group('macos add feature', () {
    ...
    test('completes successfully with correct output', () async {
      ...
      verify(() => logger.success('Added macOS feature $name.')).called(1);
      verify(() => logger.info('')).called(1);
    ...
    test('exits with 78 when the feature already exists', () async {
      ...
      verify(
        () => logger.err(
          'The feature "$name" does already on macOS.',
        ),
      ).called(1);
      verify(() => logger.info('')).called(1);
