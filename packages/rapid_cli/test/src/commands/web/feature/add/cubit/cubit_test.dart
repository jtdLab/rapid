...
void main() {
  group('web feature add cubit', () {
    ...
    test(
      ...
      withRunnerOnProject(
        ...
        // Act
        final result = await commandRunner.run(
            ['web', 'feature', 'add', 'cubit', '--feature-name', 'some_feat']);
    ...
    test('completes successfully with correct output', () async {
      ...
      verify(() => logger.success(
              'Added ${cubitName.pascalCase}Cubit to Web feature $featureName.'))
          .called(1);
 ...
 This command should be run from the root of your Rapid project.''')).called(1);
    ...
    test('exits with 78 when the feature does not exists', () async {
      ...
      // Assert
      verify(() =>
              logger.err('The feature "$featureName" does not exist on Web.'))
          .called(1);
