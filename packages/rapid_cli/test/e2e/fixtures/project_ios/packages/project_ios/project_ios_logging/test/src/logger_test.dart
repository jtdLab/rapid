...
void main() {
  ...
  group('ProjectIosLoggerDevelopment', () {
    ...
    late ProjectIosLoggerDevelopment underTest;
    ...
    setUp(() {
      ...
      underTest = ProjectIosLoggerDevelopment()
  ...
  group('ProjectIosLoggerTest', () {
    late LogCommand logCommand;
    late ProjectIosLoggerTest underTest;
    ...
    setUp(() {
      ...
      underTest = ProjectIosLoggerTest()..logCommandOverrides = logCommand;
    });
  ...
  group('ProjectIosLoggerProduction', () {
    late LogCommand logCommand;
    late ProjectIosLoggerProduction underTest;
    ...
    setUp(() {
      ...
      underTest = ProjectIosLoggerProduction()
        ..logCommandOverrides = logCommand;
    });
