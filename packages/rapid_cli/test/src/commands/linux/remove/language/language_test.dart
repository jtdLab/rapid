...
const expectedUsage = [
  'Removes a language from the Linux part of an existing Rapid project.\n'
      '\n'
      'Usage: rapid linux remove language <language>\n'
...
void main() {
  group('linux remove language', () {
    ...
    late LinuxRemoveLanguageCommand command;
    ...
    setUp(() {
      ...
      command = LinuxRemoveLanguageCommand(
        logger: logger,
        project: project,
    ...
    test('lang is a valid alias', () {
      // Arrange
      command = LinuxRemoveLanguageCommand(project: project);
    ...
    test(
      ...
      withRunnerOnProject(
        ...
        // Act
        final result = await commandRunner.run(['linux', 'remove', 'language']);
    ...
    test(
      ...
      withRunnerOnProject(
        ...
        final result = await commandRunner
            .run(['linux', 'remove', 'language', 'de', 'fr']);
    ...
    test(
      ...
      withRunnerOnProject(
        ...
        // Act
        final result =
            await commandRunner.run(['linux', 'remove', 'language', language]);
 ...
 This command should be run from the root of your Rapid project.''')).called(1);
    ...
    test('exits with 78 when no Linux features exist', () async {
      ...
      // Assert
      verify(() => logger.err('No Linux features found!\n'
    ...
    test(
      ...
      // Assert
      verify(() => logger.err('The Linux part of your project is corrupted.\n'
