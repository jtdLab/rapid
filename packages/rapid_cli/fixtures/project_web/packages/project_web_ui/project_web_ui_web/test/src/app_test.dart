...
void main() {
  group('ProjectWebApp', () {
    ...
    ProjectWebApp projectWebApp() => ProjectWebApp(
    ...
    testWidgets('renders MaterialApp with correct properties', (tester) async {
      // Act
    ...
    testWidgets(
        'renders MaterialApp with correct properties when home is not null',
        (tester) async {
      // Arrange
