...
/// returned by `ExampleIosLoginPageLocalizations.of(context)`.
///
/// Applications need to include `ExampleIosLoginPageLocalizations.delegate()` in their app's
/// `localizationDelegates` list, and the locales they support in the app's
/// `supportedLocales` list. For example:
///
/// ```dart
/// import 'l10n/example_ios_login_page_localizations.dart';
///
/// return MaterialApp(
///   localizationsDelegates: ExampleIosLoginPageLocalizations.localizationsDelegates,
///   supportedLocales: ExampleIosLoginPageLocalizations.supportedLocales,
...
abstract class ExampleIosLoginPageLocalizations {
  ...
  /// Title text shown in the Login Page
  ///
  /// In en, this message translates to:
  /// **'Login Page title for en'**
  String get title;
}
