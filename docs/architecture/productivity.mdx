...
<Warning>
Some of these scripts have requirements to run successfully. Please refer to the `melos.yaml` file in the project root for more information.
</Warning>
...
<Info>
  ...
  [static meta-programming](https://github.com/dart-lang/language/issues/1482) has the
