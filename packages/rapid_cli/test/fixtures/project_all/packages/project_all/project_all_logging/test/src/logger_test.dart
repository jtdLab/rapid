import 'package:project_all_logging/src/logger.dart';
...
void main() {
  ...
  group('ProjectAllLoggerDevelopment', () {
    late LogCommand logCommand;
    late ProjectAllLoggerDevelopment underTest;
    ...
    setUp(() {
      ...
      underTest = ProjectAllLoggerDevelopment()
  ...
  group('ProjectAllLoggerTest', () {
    late LogCommand logCommand;
    late ProjectAllLoggerTest underTest;
    ...
    setUp(() {
      ...
      underTest = ProjectAllLoggerTest()..logCommandOverrides = logCommand;
    });
  ...
  group('ProjectAllLoggerProduction', () {
    late LogCommand logCommand;
    late ProjectAllLoggerProduction underTest;
    ...
    setUp(() {
      ...
      underTest = ProjectAllLoggerProduction()
        ..logCommandOverrides = logCommand;
    });
