    ...
    () {
      ...
      test(
        ...
        () async {
          ...
          final activateWindowsResult = await commandRunner.run(
            ['activate', 'windows'],
          );
          expect(activateWindowsResult, equals(ExitCode.success.code));
          ...
          final integrationTestResult = await Process.run(
            'flutter',
            ['test', 'integration_test/development_test.dart', '-d', 'windows'],
