...
void main() {
  ...
  group('ProjectWebLoggerDevelopment', () {
    ...
    late ProjectWebLoggerDevelopment underTest;
    ...
    setUp(() {
      ...
      underTest = ProjectWebLoggerDevelopment()
  ...
  group('ProjectWebLoggerTest', () {
    late LogCommand logCommand;
    late ProjectWebLoggerTest underTest;
    ...
    setUp(() {
      ...
      underTest = ProjectWebLoggerTest()..logCommandOverrides = logCommand;
    });
  ...
  group('ProjectWebLoggerProduction', () {
    late LogCommand logCommand;
    late ProjectWebLoggerProduction underTest;
    ...
    setUp(() {
      ...
      underTest = ProjectWebLoggerProduction()
        ..logCommandOverrides = logCommand;
    });
