...
- `rapid infrastructure <subinfrastructure>`: Work with the subinfrastructure <subinfrastructure>.
  ...
  - `rapid infrastructure <subinfrastructure> add`: Remove a component from the subinfrastructure <subinfrastructure>.
    - `rapid infrastructure <subinfrastructure> add data_transfer_object`: Remove a data transfer object from the subinfrastructure <subinfrastructure>.
    - `rapid infrastructure <subinfrastructure> add service_implementation`: Remove a service implementation from the subinfrastructure <subinfrastructure>.
