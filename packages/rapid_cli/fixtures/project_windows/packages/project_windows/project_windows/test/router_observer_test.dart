...
import 'package:project_windows/router_observer.dart';
import 'package:project_windows_logging/project_windows_logging.dart';
import 'package:mocktail/mocktail.dart';

class _MockProjectWindowsLogger extends Mock implements ProjectWindowsLogger {}
...
void main() {
  group('ProjectWindowsRouterObserver', () {
    late ProjectWindowsLogger logger;
    late ProjectWindowsRouterObserver underTest;

    setUp(() {
      logger = _MockProjectWindowsLogger();
      when(() => logger.debug(any())).thenReturn(null);
      underTest = ProjectWindowsRouterObserver(logger);
    });
