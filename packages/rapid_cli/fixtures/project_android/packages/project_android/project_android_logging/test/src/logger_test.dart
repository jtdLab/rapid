...
void main() {
  ...
  group('ProjectAndroidLoggerDevelopment', () {
    ...
    late ProjectAndroidLoggerDevelopment underTest;
    ...
    setUp(() {
      ...
      underTest = ProjectAndroidLoggerDevelopment()
  ...
  group('ProjectAndroidLoggerTest', () {
    late LogCommand logCommand;
    late ProjectAndroidLoggerTest underTest;
    ...
    setUp(() {
      ...
      underTest = ProjectAndroidLoggerTest()..logCommandOverrides = logCommand;
    });
  ...
  group('ProjectAndroidLoggerProduction', () {
    late LogCommand logCommand;
    late ProjectAndroidLoggerProduction underTest;
    ...
    setUp(() {
      ...
      underTest = ProjectAndroidLoggerProduction()
        ..logCommandOverrides = logCommand;
    });
