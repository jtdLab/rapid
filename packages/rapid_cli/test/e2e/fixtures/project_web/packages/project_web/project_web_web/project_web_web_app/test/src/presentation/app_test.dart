...
void main() {
  group('App', () {
    ...
    testWidgets('renders ProjectWebApp with correct properties',
      ...
      expect(projectWebApp.home, null);
    });
    ...
    testWidgets(
        'renders ProjectWeb with correct properties when home is not null',
        (tester) async {
      // Arrange
      home = Container();
      ...
      expect(projectWebApp.localizationsDelegates, localizationsDelegates);
      expect(projectWebApp.supportedLocales, supportedLocales);
      expect(projectWebApp.routeInformationParser, null);
      expect(projectWebApp.routerDelegate, null);
      expect(projectWebApp.locale, locale);
      expect(projectWebApp.themeMode, themeMode);
      expect(projectWebApp.home, home);
    });
  });
}
