...
const expectedUsage = [
  'Removes a language from the macOS part of an existing Rapid project.\n'
      '\n'
      'Usage: rapid macos remove language <language>\n'
...
void main() {
  group('macos remove language', () {
    ...
    late MacosRemoveLanguageCommand command;
    ...
    test('lang is a valid alias', () {
      // Arrange
      command = MacosRemoveLanguageCommand(project: project);
    ...
    test(
      ...
      withRunnerOnProject(
        ...
        // Act
        final result = await commandRunner.run(['macos', 'remove', 'language']);
    ...
    test(
      ...
      withRunnerOnProject(
        ...
        final result = await commandRunner
            .run(['macos', 'remove', 'language', 'de', 'fr']);
    ...
    test(
      ...
      withRunnerOnProject(
        ...
        // Act
        final result =
            await commandRunner.run(['macos', 'remove', 'language', language]);
