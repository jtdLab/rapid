...
void main() {
  ...
  group('ProjectWindowsLoggerDevelopment', () {
    ...
    late ProjectWindowsLoggerDevelopment underTest;
    ...
    setUp(() {
      ...
      underTest = ProjectWindowsLoggerDevelopment()
  ...
  group('ProjectWindowsLoggerTest', () {
    late LogCommand logCommand;
    late ProjectWindowsLoggerTest underTest;
    ...
    setUp(() {
      ...
      underTest = ProjectWindowsLoggerTest()..logCommandOverrides = logCommand;
    });
  ...
  group('ProjectWindowsLoggerProduction', () {
    late LogCommand logCommand;
    late ProjectWindowsLoggerProduction underTest;
    ...
    setUp(() {
      ...
      underTest = ProjectWindowsLoggerProduction()
        ..logCommandOverrides = logCommand;
    });
