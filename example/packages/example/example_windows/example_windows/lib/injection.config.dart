...
import 'package:example_windows_app/example_windows_app.dart' as _i16;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    await _i16.ExampleWindowsAppPackageModule().init(gh);
    await _i10.ExampleWindowsHomePagePackageModule().init(gh);
    return this;
  }
}
