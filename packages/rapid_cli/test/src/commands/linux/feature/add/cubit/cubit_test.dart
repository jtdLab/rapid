...
const expectedUsage = [
  'Adds a cubit to a feature of the Linux part of an existing Rapid project.\n'
      '\n'
      'Usage: rapid linux feature add cubit <name> [arguments]\n'
...
void main() {
  group('linux feature add cubit', () {
    ...
    test('can be instantiated without explicit logger', () {
      // Act
      command = LinuxFeatureAddCubitCommand(project: project);
    ...
    test(
      ...
      withRunnerOnProject(
        ...
        final result = await commandRunner
            .run(['linux', 'feature', 'add', 'cubit', 'FooBar']);
