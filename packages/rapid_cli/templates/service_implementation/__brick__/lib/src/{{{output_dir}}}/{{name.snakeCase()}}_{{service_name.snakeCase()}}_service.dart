...
import 'package:{{project_name.snakeCase()}}_{{#pathCase}}domain{{#has_subinfrastructure_name}}_{{subinfrastructure_name}}{{/has_subinfrastructure_name}}/{{{output_dir}}}{{/pathCase}}/i_{{service_name.snakeCase()}}_service.dart';
