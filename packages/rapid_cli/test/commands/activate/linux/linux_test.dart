...
void main() {
  group('linux', () {
    ...
    test('completes successfully with correct output', () async {
      ...
      verify(() => logger.progress('Activating Linux')).called(1);
      ...
      verify(() => appPackagePubspec.addDependency('${projectName}_linux_app'))
          .called(1);
      ...
      verify(() =>
              diPackagePubspec.addDependency('${projectName}_linux_home_page'))
          .called(1);
      ...
      expect(progressLogs, ['Activated Linux']);
