...
const expectedUsage = [
  'Set the default language of the iOS part of an existing Rapid project.\n'
      '\n'
      'Usage: rapid ios set default_language <language>\n'
...
void main() {
  group('ios set default_language', () {
    ...
    late IosSetDefaultLanguageCommand command;
    ...
    setUp(() {
      ...
      command = IosSetDefaultLanguageCommand(
        logger: logger,
        project: project,
    ...
    test('default_lang is a valid alias', () {
      // Arrange
      command = IosSetDefaultLanguageCommand(project: project);
    ...
    test(
      ...
      withRunnerOnProject(
        ...
        // Act
        final result =
            await commandRunner.run(['ios', 'set', 'default_language']);
    ...
    test(
      ...
      withRunnerOnProject(
        ...
        final result = await commandRunner
            .run(['ios', 'set', 'default_language', 'de', 'fr']);
    ...
    test(
      ...
      withRunnerOnProject(
        ...
        // Act
        final result = await commandRunner
            .run(['ios', 'set', 'default_language', language]);
    ...
    test('completes successfully with correct output', () async {
      ...
      verify(
        () => logger.success(
          'Set $language as the default language of the iOS part of your project.',
        ),
      ).called(1);
      verify(() => logger.info('')).called(1);
